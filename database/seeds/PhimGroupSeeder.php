...
class PhimSeeder extends Seeder{
    ...
    public function run()
    {
        DB::table('Phim')->insert([
            ['ten'=>'No Game No Life','kieu'=>'TV Series','tomTat'=>'Câu chuyện xoay quanh 2 anh em Sora và Shiro là người đã tạo ra một huyền thoại của thế giới ảo, một gamer được mệnh danh là “bất khả chiến bại”. Nhưng đằng sau hào quang trong thế giới ảo, 2 anh em họ lại là những NEET, những người “vô dụng” của xã hội. Một ngày nọ, họ được một người tự xưng là “Chúa” đưa tới một thế giới của ông ta, thế giới “Board World”, nơi mà mọi thứ đều được quyết định bằng các trò chơi, từ tính mạng con người cho đến biên giới quốc gia. Liệu 2 gamer mạnh nhất của nhân loại có tiếp tục tỏa sáng trong thế giới mà họ luôn mơ tới, và vuơn tới đỉnh cao như họ luôn làm.','soTap'=>'12','thoiLuong'=>'23 phút 1 tập','nguon'=>'Light Novel','ngonNgu'=>'Japanese','phanLoaiDoTuoi'=>'PG-13','trangThai'=>'Đã kết thúc','ngayCongChieu'=>'Spring 2014','idHangSanXuat'=>'5'],

            ['ten'=>'Hyouka','kieu'=>'TV Series','tomTat'=>'Câu chuyện xoay quanh Houtarou, người có cách sống khá xa cách và thờ ơ, luôn tìm cách để tiết kiệm năng lượng hết mức có thể. Cậu bị chị mình ép phải gia nhập câu lạc bộ văn học. Tại đó, cậu đã cùng những người bạn của mình tìm thấy một tuyển tập có tên là Hyouka, và đến gần hơn với những bí ẩn 33 năm trước.','soTap'=>'22','thoiLuong'=>'25 phút 1 tập','nguon'=>'Light Novel','ngonNgu'=>'Japanese','phanLoaiDoTuoi'=>'PG-13','trangThai'=>'Đã kết thúc','ngayCongChieu'=>'Spring 2012','idHangSanXuat'=>'19'],
        ]);
    }
}
...
class Phim_TheLoaiSeeder extends Seeder{
    ...
    public function run()
    {
        DB::table('Phim_TheLoai')->insert([
            //No Game No Life
            ['idPhim'=>'1','idTheLoai'=>'2'],
            ['idPhim'=>'1','idTheLoai'=>'4'],
            ['idPhim'=>'1','idTheLoai'=>'8'],
            ['idPhim'=>'1','idTheLoai'=>'9'],
            ['idPhim'=>'1','idTheLoai'=>'10'],
            ['idPhim'=>'1','idTheLoai'=>'38'],

            //Hyouka
            ['idPhim'=>'2','idTheLoai'=>'21'],
            ['idPhim'=>'2','idTheLoai'=>'27'],
            ['idPhim'=>'2','idTheLoai'=>'34'],
        ]);
    }
}
